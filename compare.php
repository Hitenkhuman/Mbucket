...
<body>
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-1 offset-4">
                    <button id="mobsel" class="btn btn-primary">
                        Next
                    </button>
                </div>
            </div>
            ...
            <div class="row" id="comparebtn" style="display:none;">
                <div class="col-12 col-md-1 offset-4">
                    <button id="compare" class="btn btn-success">
                        Compare
                    </button>
                </div>
            </div>
